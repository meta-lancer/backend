...
public class PaymentInfoManagementEntity extends BaseTimeEntity implements Serializable {
    ...
    PaymentInfoType paymentInfoType = PaymentInfoType.PERSONAL;
    @Column(nullable = false)
    ...
    public PaymentInfoManagementEntity(CreatorEntity creatorEntity, String registerNo,
        String idCardCopy, String bank, String accountNo,
        String accountCopy, boolean incomeAgree, PaymentInfoType paymentInfoType) {
    ...
    public void update(String registerNo, String bank, String accountNo) {
        this.registerNo = registerNo;
        this.bank = bank;
        this.accountNo = accountNo;
    }
