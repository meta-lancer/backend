...
public interface CartJpaRepository extends JpaRepository<CartEntity, Long> {
    ...
    Page<CartEntity> findAllByUserAndStatus(User user, DataStatus status, Pageable pageable);

    List<CartEntity> findAllByUserAndProducts(User user, ProductsEntity products);
    ...
    Optional<CartEntity> findByUserAndProductsAndProductsRequestOptionEntityAndStatus(User user,
        ProductsEntity products, ProductsRequestOptionEntity productsRequestOptionEntity,
        DataStatus status);
